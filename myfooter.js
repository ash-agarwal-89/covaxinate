        ...
        <footer class="footer">
            <div class="footer-items">
                <ul class="footer-social-list">
                    <li><a href="mailto:myapps.amplified@gmail.com" class="terms-of-use"><i class="fas fa-envelope gmail"></i> mail us</a></li>
                    <li><a href="#" class="feedback"><i class="fab fa-facebook facebook"></i> follow us</a></li>
                    <li><a href="https://twitter.com/covaxinate" class="terms-of-use"><i class="fab fa-twitter tweet"></i> tweet us</a></li>
